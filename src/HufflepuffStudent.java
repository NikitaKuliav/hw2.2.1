public class HufflepuffStudent extends HogwartsStudent{
    ...
    public HufflepuffStudent(String name, int magic, int transgression, int dilligence, int loyalty, int honesty) {
        super(name, magic, transgression);
        this.diligence = dilligence;
        this.loyalty = loyalty;
        this.honesty = honesty;
    }

    public int getDilligence() {
        return diligence;
    }

    public void setDilligence(int dilligence) {
        this.diligence = dilligence;
    }
