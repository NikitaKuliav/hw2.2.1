public class SlytherinStudent extends HogwartsStudent{
    ...
    public String toString() {
        return String.format("%s; хитрость: %d; решимость: %d; амбициозность: %d; находчивость: %d; жажда власти: %d", super.toString(), cunning, determination, ambition, ingenuity, thirstForPower);
    }
}
